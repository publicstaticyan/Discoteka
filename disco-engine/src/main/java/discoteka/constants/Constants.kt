...
class Constants {
    companion object {
        ...
        val VOTE_CHEST_ITEM = StackBuilder(Material.CHEST).setName("§b§lVOTAÇÃO").toItemStack()
        val EASY_GRID = listOf(
            Pair(42, 21),
            Pair(21, 21),
            Pair(14, 14),
            Pair(42, 14),
        ...
        val COLORS = arrayOf(
            StackBuilder(Material.ORANGE_CONCRETE).setName("§f§f§5§f§0§0§lLARANJA"),
            StackBuilder(Material.MAGENTA_CONCRETE).setName("§d§lMAGENTA"),
            StackBuilder(Material.LIGHT_BLUE_CONCRETE).setName("§9§lAZUL CLARO"),
            ...
            StackBuilder(Material.GREEN_CONCRETE).setName("§a§lVERDE"),
